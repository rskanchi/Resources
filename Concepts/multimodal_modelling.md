...
Javed Khan group neural network RMS
Zobeck pubs



clinical
genetic, somatic variants
transcriptomic
histopathology (H&E images) 510 slides
clinical

cohort size: 
Cardiac as a surrogate for several other diseases
Transcriptional data - someone else working on it

Data sources


Can you share the pdf you just showed
GitHub repository?
- Github Javed Khan

Action items
Grant starts Dec 2025 - great lead time!
Javed and Zobeck articles
Get image data - to play with the methods
Github repository
Put data together
