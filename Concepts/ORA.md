...
- \(k\) is the number of selected genes in the gene set
- \(n\) is the total number of selected genes
...
- \(M\) is the number of genes in the gene set that are present in the background
